...
#ifndef RUMP_SYS_RENAME_UUIDGEN
#define RUMP_SYS_RENAME_UUIDGEN rump___sysimpl_uuidgen
#endif
...
int rump_sys_uuidgen(struct uuid *, int) __RENAME(RUMP_SYS_RENAME_UUIDGEN);
